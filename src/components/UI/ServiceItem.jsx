...
function ServiceItem({
  ...
  return (
    <div
      className="h-[30vh] min-w-[300px] max-w-[400px] w-full relative cursor-pointer group"
      key={id}
    >
      <div
      ...
      >
        ...
        <h1 className="relative z-10 text-white text-2xl font-semibold pl-6 md:text-3xl pt-6 drop-shadow font-[Roboto_Mono]">
          {name}
        </h1>
      </div>
